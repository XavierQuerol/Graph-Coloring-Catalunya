...
def obtain_colours(matrix, population_size = 300, prob_mutation = 0.1, max_generations = 500,
    ...
    while num_colors > 0:
        ...
        while min(ind['penalty'] for ind in population_dict) > 0 and generations < max_generations:
            ...
            results2 = get_results(results2, population_dict, num_colors, total_generations, fitness_evaluations)
            generations += 1
            total_generations += 1
